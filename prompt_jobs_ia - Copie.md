...
1. L’architecture détaillée du module IA.
2. Les modèles SQLAlchemy nouveaux ou modifiés.
3. Les migrations Alembic.
4. Les schémas Pydantic.
5. Le wrapper IA et ses adaptateurs.
6. Le service de sélection de clé.
7. Le service de retry/fallback.
8. Les prompts IA.
9. Les tâches Celery.
10. Les endpoints admin et internes.
11. Le service de validation des résultats IA.
12. Le mécanisme de vérification différée.
13. Les tests.
14. La documentation.
15. Les commandes de lancement et de test.

Important :
- Ne casse pas le pipeline d’ingestion existant.
- Ne rends pas les offres brutes visibles publiquement.
- Ne stocke jamais les clés IA en clair.
- Prévois un mode mock pour tester sans vraie API IA.
- Le code doit être modulaire, testable et prêt à recevoir plusieurs fournisseurs IA.