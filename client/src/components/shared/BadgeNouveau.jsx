...
const BadgeNouveau = ({ label = "Nouveau", variant = "soft", className }) => {
  ...
  return (
    <span className={cn("inline-flex shrink-0 items-center gap-1.5 rounded-full bg-brand-orange/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-brand-orange", className)}>
