...
/* États de section — page Paramètres (même pattern que LogsPage/Journal). */
...
export const SectionAucunResultat = ({ message = "Aucun paramètre ne correspond aux critères.", onReset }) => (
  <Empty>
    <EmptyHeader>
