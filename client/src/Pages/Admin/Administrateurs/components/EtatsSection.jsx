...
/* États de section — page Administrateurs (même pattern que Sources). */
...
export const SectionAucunResultat = ({ message = "Aucun administrateur ne correspond aux critères.", onReset }) => (
  <Empty>
    <EmptyHeader>
